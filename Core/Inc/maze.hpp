...
public:
    ...
    false: node is old
    */
    bool checkNode(int distance)
    {
        unsigned int current_coordinate[2];
        if (direction == NORTH)
        {
        ...
        {
            if (abs(current_coordinate[0] - coordinate_array[i][0]) < TOLERANCE && abs(current_coordinate[0] - coordinate_array[i][1]) < TOLERANCE)
            {
                return i;
            }
        }
    ...
    {
        total_nodes += 1;
        explored_array[total_nodes] = 1;
        node_array[total_nodes] = total_nodes - 1;
        type_array[total_nodes] = type;
        if (direction == NORTH)
        {
            coordinate_array[total_nodes][0] = old_coordinate[0];
            coordinate_array[total_nodes][1] = old_coordinate[1] + distance;
        }
        else if (direction == SOUTH)
        {
            coordinate_array[total_nodes][0] = old_coordinate[0];
        ...
        {
            coordinate_array[total_nodes][0] = old_coordinate[0] + distance;
            coordinate_array[total_nodes][1] = old_coordinate[1];
        }
        else if (direction == EAST)
        {
            coordinate_array[total_nodes][0] = old_coordinate[0] - distance;
        ...
        old_coordinate[0] = coordinate_array[total_nodes][0];
        old_coordinate[1] = coordinate_array[total_nodes][1];
        traverse_list[count] = total_nodes;
    }
};
